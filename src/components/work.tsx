...
const carouselItems = [
  <div key={1} className="h-[420px] sm:h-[420px] w-[300px] sm:w-[380px] md:h-[500px] md:w-[360px] bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl p-6 sm:p-8 text-white">
  ...
  <div key={2} className="h-[420px] sm:h-[420px] w-[300px] sm:w-[380px] md:h-[500px] md:w-[360px] bg-gradient-to-br from-green-500 to-blue-600 rounded-3xl p-6 sm:p-8 text-white">
  ...
  <div key={3} className="h-[420px] sm:h-[420px] w-[300px] sm:w-[380px] md:h-[500px] md:w-[360px] bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl p-6 sm:p-8 text-white">
  ...
  <div key={4} className="h-[420px] sm:h-[420px] w-[300px] sm:w-[380px] md:h-[500px] md:w-[360px] bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl p-6 sm:p-8 text-white">
